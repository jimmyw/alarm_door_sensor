...
#define _0000_SAU_CLOCK_SELECT_CK00                                            \
  (0x0000U) /* operation clock CK0 set by PRS register */
#define _8000_SAU_CLOCK_SELECT_CK01                                            \
  (0x8000U) /* operation clock CK1 set by PRS register */
/* Selection of transfer clock (TCLK) of channel n (CCSmn) */
#define _0000_SAU_CLOCK_MODE_CKS                                               \
  (0x0000U) /* divided operation clock MCK specified by CKSmn bit */
#define _4000_SAU_CLOCK_MODE_TI0N                                              \
  (0x4000U) /* clock input from SCK pin (slave transfer in CSI mode) */
/* Selection of start trigger source (STSmn) */
#define _0000_SAU_TRIGGER_SOFTWARE                                             \
  (0x0000U)                             /* only software trigger is valid */
...
#define _0000_SAU_EDGE_FALL                                                    \
  (0x0000U) /* falling edge is detected as the start bit */
#define _0040_SAU_EDGE_RISING                                                  \
  (0x0040U) /* rising edge is detected as the start bit */
...
#define _0400_SAU_INTSRE_ENABLE                                                \
  (0x0400U) /* enables generation of error interrupt INTSREx */
...
#define _0004_SAU_FRAM_ERROR                                                   \
  (0x0004U) /* a framing error occurs during UART reception */
/* Parity error detection flag of channel n (PEFmn) */
#define _0002_SAU_PARITY_ERROR                                                 \
  (0x0002U) /* a parity error occurs or ACK is not detected */
...
#define _0001_SAU_CH0_START_TRG_ON                                             \
  (0x0001U) /* sets SEm0 to 1 and enters the communication wait status */
...
#define _0002_SAU_CH1_START_TRG_ON                                             \
  (0x0002U) /* sets SEm1 to 1 and enters the communication wait status */
...
#define _0004_SAU_CH2_START_TRG_ON                                             \
  (0x0004U) /* sets SEm2 to 1 and enters the communication wait status */
...
#define _0008_SAU_CH3_START_TRG_ON                                             \
  (0x0008U) /* sets SEm3 to 1 and enters the communication wait status */
...
#define _0001_SAU_CH0_STOP_TRG_ON                                              \
  (0x0001U) /* operation is stopped (stop trigger is generated) */
...
#define _0002_SAU_CH1_STOP_TRG_ON                                              \
  (0x0002U) /* operation is stopped (stop trigger is generated) */
...
#define _0004_SAU_CH2_STOP_TRG_ON                                              \
  (0x0004U) /* operation is stopped (stop trigger is generated) */
...
#define _0008_SAU_CH3_STOP_TRG_ON                                              \
  (0x0008U) /* operation is stopped (stop trigger is generated) */
...
#define _0000_SAU_CH0_SNOOZE_OFF                                               \
  (0x0000U) /* disable start function from STOP state of chip */
#define _0001_SAU_CH0_SNOOZE_ON                                                \
  (0x0001U) /* enable start function from STOP state of chip */
...
#define _40_IICA_COMMUNICATION_EXIT                                            \
  (0x40U) /* exit from current communication */
...
#define _00_IICA_WAITINT_CLK8FALLING                                           \
  (0x00U) /* generated at the eighth clock's falling edge */
#define _08_IICA_WAITINT_CLK9FALLING                                           \
  (0x08U) /* generated at the ninth clock's falling edge */
...
#define _80_IICA_STARTFLAG_UNSUCCESSFUL                                        \
  (0x80U) /* start condition generation unsuccessful */
...
#define _00_IICA_START_WITHSTOP                                                \
  (0x00U) /* generate start condition upon detecting a stop condition */
#define _02_IICA_START_WITHOUTSTOP                                             \
  (0x02U) /* generate start condition without detection of a stop condition */
/* Communication reservation function disable bit (IICRSVn) */
#define _00_IICA_RESERVATION_ENABLE                                            \
  (0x00U) /* enable communication reservation */
#define _01_IICA_RESERVATION_DISABLE                                           \
  (0x01U) /* disable communication reservation */
...
#define _00_IICA_WAKEUP_STOP                                                   \
  (0x00U) /* stop address match wakeup function in STOP mode */
#define _80_IICA_WAKEUP_ENABLE                                                 \
  (0x80U) /* enable address match wakeup function in STOP mode */
...
Macro definitions
***********************************************************************************************************************/
#define _6600_CSI00_DIVISOR (0x6600U)
